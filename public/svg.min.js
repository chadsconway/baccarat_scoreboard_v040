...
var SVG = (function () {
  ...
  function S(t, e = !1) {
    ...
    return (
      (n.innerHTML = t), (t = D(n.firstChild)), n.removeChild(n.firstChild), t
    );
  }
  function E(t, e) {
  ...
  function I(t, e = t.name, n = !1) {
    return (
      (T[e] = t), n && (T[C] = t), r(Object.getOwnPropertyNames(t.prototype)), t
    );
  }
  function z(t) {
    return T[t];
  ...
  n("Dom", {
    ...
    n("Dom", {
      css: function (t, e) {
        ...
        return (
          2 === arguments.length &&
            (this.node.style[u(t)] = null == e || Q.test(e) ? "" : e),
          this
        );
      },
      show: function () {
    ...
    init(t, e) {
      const n = 0,
        ...
        r = Array.isArray(t)
          ...
          : { x: t, y: e };
      return (
        (this.x = null == r.x ? n : r.x), (this.y = null == r.y ? i : r.y), this
      );
    }
    toArray() {
  ...
  class ut {
    ...
    static matrixMultiply(t, e, n) {
      ...
      return (
        (n.a = i), (n.b = r), (n.c = s), (n.d = o), (n.e = h), (n.f = u), n
      );
    }
    around(t, e, n) {
    ...
    viewbox: {
      ...
      zoom(t, e) {
        ...
        u === 1 / 0 && (u = Number.MAX_SAFE_INTEGER / 100),
          (e = e || new ot(n / 2 / s + r.x, i / 2 / o + r.y));
  ...
  function Mt(t, e, n, i) {
    ...
    return (
      e instanceof x.window.Event ||
        (e = new x.window.CustomEvent(e, { detail: n, cancelable: !0, ...i })),
      r.dispatchEvent(e),
      e
    );
  }
  ...
  class Dom extends Ot {
    ...
    clone(t = !0) {
      return (
        this.writeDataToDom(), new this.constructor(P(this.node.cloneNode(t)))
      );
    }
    each(t, e) {
    ...
    attr: function (t, e, n) {
      ...
      if ("object" == typeof t && t.constructor === Object)
        ...
        "number" == typeof (e = Et.reduce((e, n) => n(t, e, this), e))
          ...
          : st.isColor(e)
          ? (e = new st(e))
          : e.constructor === Array && (e = new Nt(e)),
          "leading" === t
  ...
  (Gt = function (t, e, n) {
    return (
      ("fill" !== t && "stroke" !== t) ||
        (Z.test(e) && (e = n.root().defs().image(e))),
      e instanceof Image &&
        (e = n
          .root()
          .defs()
  ...
  class Line extends Shape {
    ...
    plot(t, e, n, i) {
      return null == t
        ? this.array()
        : ((t =
            void 0 !== e ? { x1: t, y1: e, x2: n, y2: i } : new $t(t).toLine()),
          this.attr(t));
    }
    size(t, e) {
      const n = c(this, t, e);
  ...
  class fe extends Nt {
    bbox() {
      return (
        at().path.setAttribute("d", this.toString()),
        new ct(at.nodes.path.getBBox())
      );
    }
    move(t, e) {
      const n = this.bbox();
    ...
    parse(t = "M0 0") {
      return (
        ...
        (function (t, e = !0) {
          ...
          return (
            r.inNumber && ue(r, !1), r.inSegment && oe(r) && ae(r), r.segments
          );
        })(t)
      );
    }
  ...
  class ye {
    ...
    init(t) {
      return (
        ...
        Object.assign(this, ye.defaults, t),
        this
      );
    }
    toArray() {
  ...
  class _e {
    ...
    init(t) {
      ...
      return (
        e.sort(we), (this.values = e.reduce((t, e) => t.concat(e), [])), this
      );
    }
    toArray() {
      return this.values;
  ...
  const Oe = {
      ...
      frame(t) {
        ...
        return (
          null === Oe.nextDraw &&
            (Oe.nextDraw = x.window.requestAnimationFrame(Oe._draw)),
          e
        );
      },
      timeout(t, e) {
  ...
  class Ce extends Ot {
    constructor(t) {
      super(),
        ...
        (this._isDeclarative = t instanceof Kt),
        (this._stepper = this._isDeclarative ? t : new Zt()),
        (this._history = {}),
        (this.enabled = !0),
        (this._time = 0),
        (this._lastTime = 0),
    ...
    Element: {
      ...
      _addRunner(t) {
        this._transformationRunners.add(t),
          Oe.cancelImmediate(this._frameId),
  ...
  F(Ce, {
      ...
      return (
        this.queue(
          ...
          function (l) {
            ...
            const { x: c, y: f } = new ot(s).transform(
          ...
          function (e) {
            (e.origin || "center").toString() !==
              (t.origin || "center").toString() && (s = f(e, o)),
              (t = { ...e, origin: s });
          },
          !0
        ),
    ...
    F(Ce, { rx: Dt, ry: It, from: Bt, to: Ht }),
    I(Ce, "Runner");
  ...
  class Text extends Shape {
    ...
    setData(t) {
      return (
        (this.dom = t), (this.dom.leading = new St(t.leading || 1.3)), this
      );
    }
    text(t) {
      if (void 0 === t) {
  ...
  F(Circle, { x: zt, y: Rt, cx: Lt, cy: Pt, width: Ft, height: qt }),
    n({
      Container: {
  ...
  class Stop extends Element {
    ...
    update(t) {
      return (
        ("number" == typeof t || t instanceof St) &&
          (t = {
            offset: arguments[0],
            color: arguments[1],
            opacity: arguments[2],
        ...
        null != t.opacity && this.attr("stop-opacity", t.opacity),
        null != t.color && this.attr("stop-color", t.color),
        null != t.offset && this.attr("offset", new St(t.offset)),
        this
      );
    }
  }
  ...
  n({
    ...
    (TextPath.prototype.MorphArray = fe),
    I(TextPath, "TextPath");
  ...
  F([Svg, Symbol, Image, Pattern, Marker], i("viewbox")),
    ...
    F([Rect, Ellipse, Gradient, Ce], i("radius")),
    F(Ot, i("EventTarget")),
    F(Dom, i("Dom")),
    F(Element, i("Element")),
    F(Shape, i("Shape")),
    F([Container, Yt], i("Container")),
    F(Gradient, i("Gradient")),
    F(Ce, i("Runner")),
    dt.extend([...new Set(e)]),
    xe([St, st, ct, ut, Nt, $t, fe]),
    be();
  var Pe = {
    __proto__: null,
    Morphable: me,
